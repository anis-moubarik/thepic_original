...
<link href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.8.5/themes/start/jquery-ui.css" rel="stylesheet" />
...
<meta name="thepic.net" http-equiv="Content-Type" content="xhtml/text; charset=utf-8" />
<meta name="robots" content="follow,index" />
<title>thepic - Terms of Service</title>
<meta name="Keywords" content="Terms of Service, terms" />
<meta name="Description" content="Thepic.nets terms of service" />
<link href="assets/styles.css" rel="stylesheet" type="text/css" />
</head>
<body>
<script type="text/javascript" src="https://thepic.net/clickheat/js/clickheat.js"></script><script type="text/javascript"><!--
clickHeatSite = '';clickHeatGroup = encodeURIComponent(window.location.pathname+window.location.search);clickHeatServer = 'https://thepic.net/clickheat/click.php';initClickHeat(); //-->
</script>
<div id="wrapper">
</div>
<div id="dragdrop">
...
<p>We make various services available on this site including, but not limited to, image upload, and other like services. You are responsible for providing, at your own expense, all equipment necessary to use the services, including a computer, modem, and Internet access (including payment of all fees associated with such access).</p>
...
<p>Copyright (c) 10.7.2011 thepic.net All Rights Reserved.</p>
...
<p>Contact: admin@thepic.net<br />Address: <br />Phone: </p>
...
<p>This site (excluding any linked sites) is controlled by us from our offices within the Germany, United States of America. It can be accessed from all 50 states, as well as from other countries around the world. As each of these places has laws that may differ from those of Germany, by accessing this site both of us agree that the statutes and laws of the State of Germany, without regard to the conflicts of laws principles thereof and the United Nations Convention on the International Sales of Goods, will apply to all matters relating to the use of this site and the purchase of products and services available through this site. Each of us agrees and hereby submits to the exclusive personal jurisdiction and venue any court of competent jurisdiction within the State of Germany with respect to such matters.</p>

<p><b>16. Notices</b></p>

<p>All notices to a party shall be in writing and shall be made either via email or conventional mail. Notices to us must be sent to the attention of Customer Service at admin@thepic.net, if by email, or at thepic.net  if by conventional mail. We may broadcast notices or messages through the site to inform you of changes to the site or other matters of importance, and such broadcasts shall constitute notice to you at the time of sending.</p>
...
<p>Except as explicitly noted on this site, the services available through this site are offered by thepic.net located at . Our telephone number is . If you notice that any user is violating these Terms of Use, please contact us at admin@thepic.net.</p>
</div>
<?php
	include 'bottom.php';
?>
